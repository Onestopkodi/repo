...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR orange]OneStop[COLORlime]Wizard[/COLOR]'
...
THEME1 = u'[COLOR {color1}][COLOR {color1}][/COLOR][COLOR {color2}][COLOR {color1}][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR orange]OneStop[COLORlime]Wizard[/COLOR]'
