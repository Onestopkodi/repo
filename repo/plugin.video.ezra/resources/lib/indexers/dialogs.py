...
def random_choice(tmdb_id, poster):
	...
	from modules import random_play
	exec('random_play.%s(tmdb_id)' % choice)
...
def extras_lists_choice():
	...
	dl = [
			...
			{'name': ls(32503),                            'image': translate_path(screenshots_directory % '002_recommended.jpg')},
			{'name': ls(32607),                            'image': translate_path(screenshots_directory % '003_reviews.jpg')},
			{'name': ls(32984),                            'image': translate_path(screenshots_directory % '004_trivia.jpg')},
			{'name': ls(32986),                            'image': translate_path(screenshots_directory % '005_blunders.jpg')},
			{'name': ls(32989),                            'image': translate_path(screenshots_directory % '006_parentalguide.jpg')},
			{'name': ls(33032),                            'image': translate_path(screenshots_directory % '007_videos.jpg')},
			{'name': ls(32616),                            'image': translate_path(screenshots_directory % '008_posters.jpg')},
			{'name': ls(32617),                            'image': translate_path(screenshots_directory % '009_fanart.jpg')},
			{'name': '%s %s' % (ls(32612), ls(32543)),     'image': translate_path(screenshots_directory % '010_morefromyear.jpg')},
			{'name': '%s %s' % (ls(32612), ls(32470)),     'image': translate_path(screenshots_directory % '011_morefromgenres.jpg')},
			{'name': '%s %s' % (ls(32612), ls(32480)),     'image': translate_path(screenshots_directory % '012_morefromnetwork.jpg')},
			{'name': '%s %s' % (ls(32612), ls(32499)),     'image': translate_path(screenshots_directory % '013_collection.jpg')}
			]
...
def results_layout_choice():
	...
	xml_choices = [
					...
					('List Details',                 translate_path(screenshots_directory % 'source_results_list.details.jpg')),
					('List Contrast Details',        translate_path(screenshots_directory % 'source_results_list.contrast.details.jpg')),
					('InfoList Default',             translate_path(screenshots_directory % 'source_results_infolist.default.jpg')),
					('InfoList Contrast Default',    translate_path(screenshots_directory % 'source_results_infolist.contrast.default.jpg')),
					('InfoList Details',             translate_path(screenshots_directory % 'source_results_infolist.details.jpg')),
					('InfoList Contrast Details',    translate_path(screenshots_directory % 'source_results_infolist.contrast.details.jpg')),
					('Rows Default',                 translate_path(screenshots_directory % 'source_results_rows.default.jpg')),
					('Rows Contrast Default',        translate_path(screenshots_directory % 'source_results_rows.contrast.default.jpg')),
					('Rows Details',                 translate_path(screenshots_directory % 'source_results_rows.details.jpg')),
					('Rows Contrast Details',        translate_path(screenshots_directory % 'source_results_rows.contrast.details.jpg')),
					('Shift Default',                translate_path(screenshots_directory % 'source_results_shift.default.jpg')),
					('Shift Contrast Default',       translate_path(screenshots_directory % 'source_results_shift.contrast.default.jpg')),
					('Shift Details',                translate_path(screenshots_directory % 'source_results_shift.details.jpg')),
					('Shift Contrast Details',       translate_path(screenshots_directory % 'source_results_shift.contrast.details.jpg')),
					('Thumb Default',                translate_path(screenshots_directory % 'source_results_thumb.default.jpg')),
					('Thumb Contrast Default',       translate_path(screenshots_directory % 'source_results_thumb.contrast.default.jpg')),
					('Thumb Details',                translate_path(screenshots_directory % 'source_results_thumb.details.jpg')),
					('Thumb Contrast Details',       translate_path(screenshots_directory % 'source_results_thumb.contrast.details.jpg'))
					]
...
def options_menu(params, meta=None):
	...
	if content in ('movie', 'episode'):
		multi_line = 'true'
		listing += [(ls(32014), '%s %s' % (ls(32533), ls(32841)), 'clear_and_rescrape')]
		listing += [(ls(32006), '%s %s' % (ls(32533), ls(32841)), 'rescrape_with_disabled')]
		listing += [(ls(32807), '%s %s' % (ls(32533), ls(32841)), 'scrape_with_filters_ignored')]
		listing += [(ls(32135), '%s %s' % (ls(32533), ls(32841)), 'scrape_with_custom_values')]
